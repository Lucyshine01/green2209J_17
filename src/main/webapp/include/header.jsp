		...
		<div class="modalMain d-flex">
			<div class="d-flex fCol_center" style="width: 50%">
				...
				<div class="p-4 ml-auto mr-auto" style="font-size: 1.1em; width: 80%;">
					<div>로그인</div>
					<input type="text" name="loginMid" id="loginMid" class="form-control mt-2 mb-3" />
					<div>비밀번호</div>
					<input type="password" name="loginPwd" id="loginPwd" class="form-control mt-2 mb-3" />
					<input type="button" value="로그인" class="btn btn-success mb-2 form-control" />
					<input type="button" value="회원가입" class="btn btn-primary mb-2 form-control" />
				</div>
				<div>
			...
			<div class="ml-auto" style="width: 45%">
				<div class="modalClose" onclick="loginModalClose();"><i class="fa-solid fa-xmark"></i></div>
