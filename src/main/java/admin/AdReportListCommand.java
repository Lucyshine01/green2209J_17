...
public class AdReportListCommand implements AdminInterface {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int totRecCnt = dao.getreportCnt();
		...
		ArrayList<reportVO> vos = dao.getreportList(stratIndexNo, pageSize);
		request.setAttribute("vos", vos);
		request.setAttribute("reportTot", totRecCnt);
