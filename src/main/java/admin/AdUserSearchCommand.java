...
public class AdUserSearchCommand implements AdminInterface {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int totRecCnt = dao.getUserSearchCnt(searching, searchItem);
		...
		ArrayList<UserVO> vos = dao.getSearchUserList(searching, searchItem, stratIndexNo, pageSize);
